...
#
# network.initialize_random_weights()
...
#
# network.train(parameters.data_file)
# network.save_weights(parameters.input_layer_weight_file, parameters.output_layer_weight_file,
#                      parameters.hidden_layer_weight_file)
